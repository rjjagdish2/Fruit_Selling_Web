...
<head>
    ...
    <link rel="stylesheet" href="./css/navPan.css">
</head>
<body>
    <div class="main">
    <div class="header">
    ...
    <?php
        ...
        if(isset($_GET['ses'])){
        if($_GET['ses']=='su'){
            echo "<iframe src='productDetails.php?ses=su'></iframe>";
        }
        elseif($_GET['ses']=='wi'){
            echo "<iframe src='productDetails.php?ses=wi'></iframe>";
        }
        elseif($_GET['ses']=='mo'){
            echo "<iframe src='productDetails.php?ses=mo'></iframe>";
        }        
        else{
            echo '<iframe src="productDetails.php"></iframe>';
        }
    }
    elseif(isset($_GET['cart'])){
        echo "<iframe src='cart.php'></iframe>";
    }
    
    else{
        echo '<iframe src="dashboard.php"></iframe>';
    }
...
<script>
    ...
    function ckh($chkname){
        ...
        if($chkname=='user'){
            ...
            // header("Location: navBar.php?user=1");
        }else{
            window.location.href="index.php?cart=1";
            // header("Location: navBar.php?cart=1");
        }
